...
/*
*
* They are plain Java programs that can live inside a Spring Boot project.
Browser commands
* automate a web browser using Selenium WebDriver in order to launch a website, verify its basic properties,
* and extract information such as page title, URL correctness, and page source length.
* */