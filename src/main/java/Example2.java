...
//(4) Input User name and Password,Automates login using valid credentials
...
//(7) Select the Departing Airport by the Value.andle dropdown elements in HTML <select> tags.
...
//(10) Select the Arriving Month by selectByVisibleText as name is not visible
...
//(13)List of Elements
        ...
        Thread.sleep(2000); //pause execution so that the web page can load completely before performing the next action.
        driver.quit();
    }
}

//automate user login and flight booking operations on a web-based application.
//navigate() also supports browser navigation like back and forward.